    ...
    function()
        while wait(1) do
            if gui.flags.Nocliplol then
                game.ReplicatedStorage.Events.DebugMode:FireServer()
                local noclip = true
...
spawn(
    function()
        while wait(1) do
            if gui.flags.hitboxlol then
                local Player = game:GetService("Players").LocalPlayer
                game:GetService("RunService").Stepped:connect(
                    function()
                        for i, v in pairs(game:GetService("Workspace").Level.Actors:GetChildren()) do
                            if v.Name ~= Player.Name then
                                v.Character.HumanoidRootPart.Size = Vector3.new(100, 100, 200)
                                v.Character.HumanoidRootPart.Transparency = 0.17
                                        ...
                                        function()
                                            ...
                                            if Head ~= nil then
                                                ...
                                                if withinScreenBounds then
                                                    ...
                                                    local IsVisible =
                                                        IsPartVisible(LP.Character:FindFirstChild("Head"), Head)
                                                    local Mag =
                                                        (LP.Character:FindFirstChild("Head").Position - Head.Position).Magnitude
                                                    local DrawColor =
                                                        Color3.fromRGB(255 / Mag * 255, 255 / 255 * Mag, 0)
                ...
                function()
                    while wait(1) do
                        if gui.flags.Crosshairlol then
                            ...
                            xl.From =
                                Vector2.new((cc.ViewportSize.X / 2) + (crosshairlength / 2 + 1), cc.ViewportSize.Y / 2)
            ...
            local screwdriverroom =
                ...
                function()
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                        CFrame.new(17.5797043, 12.6000395, 11.2429724)
                end
            )
            if getgenv().console == false then
