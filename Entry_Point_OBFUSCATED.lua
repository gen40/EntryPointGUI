...
getgenv().console = false -- synapse x/krnl/arch console, you can turn it off if you're not using synapse x, your exploit MUST support rconsoleprint if this is on
